...
public class KumamonBatteryWidget extends WidgetBase {
	...
	private static BroadcastReceiver batteryReceiver = new BroadcastReceiver() {
		final int[] IMAGE = { R.drawable.battery_0, R.drawable.battery_20,
				R.drawable.battery_40, R.drawable.battery_60,
				R.drawable.battery_80, R.drawable.battery_80 };
		int scale = 100;
		int level = 0;
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
				...
				RemoteViews remoteViews = new RemoteViews(
						context.getPackageName(), R.layout.widget_battery);
				remoteViews.setImageViewResource(R.id.battery_icon_ImageView,
